...
class _AddQuestionPageState extends State<AddQuestionPage> {
  ...
  Future<void> _addQuestionToFirestore(String imageUrl) async {
    ...
    await firestore.collection('questions').add({
      ...
      'imageUrl': imageUrl,
      'correctOption': _optionController.text.toLowerCase(),
    });
  ...
  void _checkAnswer(String correctOption, String answer) {
    if (correctOption == answer.toLowerCase()) {
      setState(() {
        correctCount++;
      });
    }
